...
print('')
phoneName=input('Enter Phone Display Name for caller ID and labeling: ')
print('')
...
softKey=( 'Adesa_Auction_Softkey_GPickup' )
...
phone = {
    ...
    'protocol': 'SIP',
    'protocolSide': 'User',
    'devicePoolName': ( 'KAR_HQ_PHONES_DP1' ),
    'description': (phoneName + ' - Phone'),
    'callingSearchSpaceName': ('DEV_' + globalName + '_CSS'),
    ...
    'phoneTemplateName': ( 'KAR HQ Universal Template' ),
