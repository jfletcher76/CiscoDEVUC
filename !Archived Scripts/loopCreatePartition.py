...
#siteXlate=input('Enter 4 digit translation pattern: ')
#siteXlatePrefix=input('Enter Site 4 digit prefix 1XXXXXX: ')

routeType = ["911", "LD", "INTL", "LOCAL", "PAGING", "PARK", "TOLLFREE", "XLATE", "NULL"]

for i in routeType:
	routePartition = {
		'name': ( globalName + '_' + i + '_PT' ),
		'description': ( globalName + '_' + i + '_PT' ),
